...
echo "Prisma Cloud Policy Violation count: $rules_matched_count";

if [ "$rules_matched_count" -ne 0 ];then
  echo "Build failed with Violation Count  $rules_matched_count because the following Prisma Cloud Policies failed:";
